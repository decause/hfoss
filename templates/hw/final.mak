...
<div class="alert alert-info">
    ...
    <ul>
        ...
        quality of your addition): <code><a class="reference external"
            href="http://wiki.sugarlabs.org/go/Math4Team/RIT/Projects">http://wiki.sugarlabs.org/go/Math4Team/RIT/Projects</a></code>
    </ul>
    <ul>
    ...
    <ul>
        ...
        <li>Does it work on the OLPC?</li>
        <li>Code quality and git commit history.</li>
        <li>Quality of the wiki entry at sugarlabs.org</li>
    </ul>
    </div>
</div>
