...
<div class="row">
    <div class="col-md-4">
        ...
        <h2><a href="${participant_data['blog']}" target="_blank">Blog</a></h2>
        <p>
            ...
            <h2><a href="https://github.com/${participant_data['github']}" target="_blank">GitHub</a></h2>
    ...
    <div class="col-md-8">
        <p>
            ...
            %if 'twitter' in participant_data:
                <h2>Twitterverse</h2>
                <a class="twitter-timeline"  href="http://twitter.com/${participant_data['twitter']}" target="_blank"  data-widget-id="369925299250544640" data-screen-name=${participant_data['twitter']}>Tweets by @${participant_data['twitter']}</a>
